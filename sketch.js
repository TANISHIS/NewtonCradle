...
function setup() {
	...
	bob1 = Bodies.circle(300, 380, 20,bob1_options);
    World.add(world,bob1);

	bob2 = Bodies.circle(340, 380, 20, bob1_options);
	World.add(world,bob2);

	bob3 = Bodies.circle(380, 380, 20, bob1_options);
	World.add(world,bob3);

	bob4 = Bodies.circle(420, 380, 20, bob1_options);
	World.add(world,bob4);

	bob5 = Bodies.circle(460, 380, 20, bob1_options);
